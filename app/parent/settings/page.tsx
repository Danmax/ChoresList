      ...
      {tab === "household" || !canManage ? <div className="space-y-5">
        ...
        <section className="rounded-3xl bg-white p-5 shadow-sm">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            ...
            <Toggle label="Allow kids to create gift lists and add items" checked={settings.privacyAllowKidWishlist} disabled={!canManage} onChange={(value) => update("privacyAllowKidWishlist", value)} />
