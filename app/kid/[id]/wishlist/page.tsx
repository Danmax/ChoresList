          ...
          {step === "category" ? (
            ...
            <div className="space-y-4 pt-2">
              ...
              <div>
                ...
                <ProductUrlInput value={form.amazonUrl} onChange={(amazonUrl) => setForm((p) => ({ ...p, amazonUrl }))} onImage={(imageUrl) => setForm((p) => ({ ...p, imageUrl }))} placeholder="Paste the exact product link here" className="mt-1 rounded-xl" />
